...
Процедура ВыполнитьКоманду(Знач КомандаПриложения) Экспорт
	...
	Иначе
		...
		Для каждого ИмяПакета Из МассивПакетовКОбновлению Цикл
			...
			// адрес хаба умеет разбирать только УстановитьПакетПоАдресу
			Если АдресаХаба.ЭтоАдресХаба(ИмяПакета) Тогда
				РаботаСПакетами.УстановитьПакетПоАдресу(ИмяПакета, РежимУстановки, , НастройкаУстановки);
			Иначе

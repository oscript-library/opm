...
Функция ОтметкаГит(Знач Адрес, Знач Коммит) Экспорт

	УстановитьСвойствоПакета("АдресОсновногоХранилища", Адрес);
	УстановитьСвойствоПакета("ИдентификаторВерсии", Коммит);
	Возврат ЭтотОбъект;
